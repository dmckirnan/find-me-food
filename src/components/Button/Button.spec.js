...
describe('<Button />', () => {
  ...
  //     expect([`${styles.reusableButton}`, `${styles.reusableRedButton}`]
  ...
  //     wrapper = mount(<Button {...newProps} />);
  //     const button = wrapper.find('button');
  //     expect([`${styles.reusableButton}`, `${styles.reusableGreenButton}`]
  //       .every(c => button.hasClass(c))).to.equal(true);
  //   });
  ...
  //     wrapper = mount(<Button {...newProps} />);
  //     const button = wrapper.find('button');
  //     expect([`${styles.reusableButton}`, `${styles.reusableWhiteBlueButton}`]
  //       .every(c => button.hasClass(c))).to.equal(true);
  //   });
  ...
  //     wrapper = mount(<Button {...newProps} />);
  //     const button = wrapper.find('button');
  //     expect([`${styles.reusableButton}`, `${styles.reusableWhiteRedButton}`]
  //       .every(c => button.hasClass(c))).to.equal(true);
  //   });
  ...
  //     wrapper = mount(<Button {...newProps} />);
  //     const button = wrapper.find('button');
  //     expect([`${styles.reusableButton}`, `${styles.reusableWhiteGreenButton}`]
  //       .every(c => button.hasClass(c))).to.equal(true);
  //   });
  // });
  ...
  //     wrapper = mount(<Button {...newProps} />);
  //     const button = wrapper.find('button');
  //     expect([`${styles.reusableButton}`, `${styles.reusableWhiteGreenButton}`, 'test']
  //       .every(c => button.hasClass(c))).to.equal(true);
  //   });
  ...
  //     wrapper = mount(<Button {...newProps} />);
  //     const button = wrapper.find('button');
  //     expect([`${styles.reusableDisabledButton}`, 'test']
  //       .every(c => button.hasClass(c))).to.equal(true);
